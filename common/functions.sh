...
BUILD_TEST_CONTAINERS=\${BUILD_TEST_CONTAINERS:-${BUILD_TEST_CONTAINERS}}
CONTRAIL_SYNC_REPOS=\${CONTRAIL_SYNC_REPOS:-${CONTRAIL_SYNC_REPOS}}
...
RUN_UNIT_TESTS=\${RUN_UNIT_TESTS:-${RUN_UNIT_TESTS}}
