...
1. to develop on nightly R5.0 container use: `sudo -E ./run.sh -t R5.1`
2. to develop code based on a tagged `r5.1` release, use: `sudo -E ./run.sh -i opencontrail/developer-sandbox -t r5.1`
